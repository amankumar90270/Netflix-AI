                ...
                <div className="relative z-10 flex items-end p-8 gap-8 ">
                    ...
                    <div>
                        ...
                        <div>
                         ...
                         text-white py-3 px-4 rounded-full cursor-pointer text-sm md:text-base mt-2 md:mt-4" >
                        ...
                        {recommendations.slice(0, 10).map((rec) => (
                            <div key={rec.id} className="bg-[#232323] rounded-lg overflow-hidden hover:scale-105 transition" >
                                <Link to={`/movie/${rec.id}`}>
                                    <img src={`https://image.tmdb.org/t/p/w300${rec.poster_path}`} className="w-full  h-48 object-cover" />
                                    <div className='p-2'>
